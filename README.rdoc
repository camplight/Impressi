Impressi is an interface that makes it easy for users to make presentations with {Impress.js}[http://bartaz.github.com/impress.js/].  It's now available to use at {Impressi.me}[http://impressi.me]  It was built as a project for {DevBootcamp}[http://devbootcamp.com] ({Github page}[https://github.com/Devbootcamp]) by the following contributors:
